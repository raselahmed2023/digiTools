    ...
    return (
        <div>
            ...
            <div className='text-center mt-10'>
                ...
                <p className='mt-2 text-gray-400'>Choose the plan that fits your needs. Upgrade or downgrade anytime.</p>
            </div>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 container mx-auto mt-10'>
                ...
                <div className="card w-96 bg-base-100 shadow indicator rounded-2xl ">
                    ...
                    <div className="card-body bg-purple-500 text-white rounded-2xl">
                        ...
                        <ul className="mt-6 flex flex-col gap-2 text-xs">
                            <li>
                                <svg xmlns="http://www.w3.org/2000/svg" className="size-4 me-2 inline-block text-success" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path
